    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    user_scope_id = table.Column<long>(type: "INTEGER", nullable: false)
            ...
            migrationBuilder.CreateTable(
                name: "t_user_scope_identifier",
                columns: table => new
                {
                    user_scope_identifier_id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    user_scope_id = table.Column<long>(type: "INTEGER", nullable: false),
                    code = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    name = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_user_scope_identifier", x => x.user_scope_identifier_id);
                    table.ForeignKey(
                        name: "FK_t_user_scope_identifier_t_user_scope_user_scope_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    user_group_user_id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    user_group_id = table.Column<long>(type: "INTEGER", nullable: false),
                    user_id = table.Column<long>(type: "INTEGER", nullable: false),
                    created_date = table.Column<DateTime>(type: "TEXT", nullable: false)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_t_user_scope_identifier_code",
                table: "t_user_scope_identifier",
                column: "code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_t_user_scope_identifier_created_date",
                table: "t_user_scope_identifier",
                column: "created_date");

            migrationBuilder.CreateIndex(
                name: "IX_t_user_scope_identifier_modified_date",
                table: "t_user_scope_identifier",
                column: "modified_date");

            migrationBuilder.CreateIndex(
                name: "IX_t_user_scope_identifier_user_scope_id",
                table: "t_user_scope_identifier",
